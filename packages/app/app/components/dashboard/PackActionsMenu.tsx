        ...
        <Menu >
            ...
            >
                <Menu.Items
                    ...
                    <Menu.Item>
                        {({active}) => (
                            <HelpItem title={'Revoke Capsule'}>
                                <p>If a Capsule hasn&apos;t been claimed, you can revoke it to retrieve your assets. This is
                                    often preferable to self-claiming the Capsule.</p>
                                <div className='flex justify-end'>
                                    <Button
                                        onClick={() => setIsRevokeOpen(true)}
                                        leftIcon={<BsX className="text-xl"/>}>Revoke Capsule </Button>
                                </div>
                            </HelpItem>
                        )}
                    </Menu.Item>
