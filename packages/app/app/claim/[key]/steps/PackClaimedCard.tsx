...
export function PackClaimedCard() {
    ...
    return <Card
        ...
        <div className="flex flex-col items-center gap-8">
            ...
            <p className='my-4 text-gray-400 text-sm'>The contents of the Capsule are now in your wallet.</p>
            <p className='my-4 text-sm'>Share this Capsule with someone on socials:</p>
